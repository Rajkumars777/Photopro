...
import { Camera, Menu, X, ArrowRight, Zap, Sun, Moon } from "lucide-react";
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="fixed top-16 left-4 right-4 z-40 glass-strong rounded-2xl p-4 border border-white/[0.1] shadow-2xl"
          >
            <div className="flex flex-col gap-1">
              ...
              <button
                onClick={() => scrollTo("#automation-section")}
                className="px-4 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-violet-600 text-white text-sm font-bold text-center cursor-pointer"
              >
                Launch Automation →
              </button>
            </div>
